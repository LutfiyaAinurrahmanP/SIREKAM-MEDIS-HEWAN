...
describe("PATCH /client/users/:id", () => {
  ...
  it("should update an existing user", async () => {
    ...
    expect(response.body.data.role).toBe("veterinarian");
