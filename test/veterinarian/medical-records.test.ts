...
describe("POST /veterinarian/medical-records", () => {
  beforeEach(async () => {
  ...
  it("should create a new medical record", async () => {
    ...
    const response = await supertest(web)
      .post("/veterinarian/medical-records")
...
describe("GET /veterinarian/medical-records", () => {
  beforeEach(async () => {
    await createData("medical-records");
  });
  afterEach(async () => {
  ...
  it("should return a list of medical records", async () => {
    const response = await supertest(web)
      .get("/veterinarian/medical-records")
      .set("SESSION-TOKEN", "token-veterinarian");
...
describe("GET /veterinarian/medical-records/:id", () => {
  beforeEach(async () => {
    await createData("medical-records");
  });
  afterEach(async () => {
  ...
  it("should get an existing medical record", async () => {
    ...
    const response = await supertest(web)
      .get(`/veterinarian/medical-records/${medicalRecord?.id}`)
      .set("SESSION-TOKEN", "token-veterinarian");
  ...
  it("should return error if medical record not found", async () => {
    const response = await supertest(web)
      .get(`/veterinarian/medical-records/99999`)
      .set("SESSION-TOKEN", "token-veterinarian");
...
describe("PATCH /veterinarian/medical-records/:id", () => {
  beforeEach(async () => {
    await createData("medical-records");
  });
  afterEach(async () => {
  ...
  it("should update an existing medical record", async () => {
    ...
    const response = await supertest(web)
      .patch(`/veterinarian/medical-records/${medicalRecord?.id}`)
      .set("SESSION-TOKEN", "token-veterinarian")
      .send({
        pet_id: pet?.id,
        service_id: service?.id,
  ...
  it("should return error if medical record not found", async () => {
    ...
    const response = await supertest(web)
      .patch(`/veterinarian/medical-records/99999`)
      .set("SESSION-TOKEN", "token-veterinarian")
      .send({
        pet_id: pet?.id,
        service_id: service?.id,
...
describe("DELETE /veterinarian/medical-records/:id", () => {
  beforeEach(async () => {
    await createData("medical-records");
  });
  afterEach(async () => {
  ...
  it("should delete an existing medical record", async () => {
    const medicalRecord = await MedicalRecordsTest.getMedicalRecordsId();
    const response = await supertest(web)
      .delete(`/veterinarian/medical-records/${medicalRecord?.id}`)
      .set("SESSION-TOKEN", "token-veterinarian");
  ...
  it("should return error if medical record not found", async () => {
    const response = await supertest(web)
      .delete(`/veterinarian/medical-records/99999`)
      .set("SESSION-TOKEN", "token-veterinarian");
