...
describe("GET /veterinarian/appointments", () => {
  beforeEach(async () => {
...
describe("GET /veterinarian/appointments/:id", () => {
  beforeEach(async () => {
    await createData("appointments");
  });
  afterEach(async () => {
  ...
  it("should get an existing appointment", async () => {
    ...
    const response = await supertest(web)
      .get(`/veterinarian/appointments/${appointment?.id}`)
      .set("SESSION-TOKEN", "token-veterinarian");
  ...
  it("should return error if appointment not found", async () => {
    const response = await supertest(web)
      .get(`/veterinarian/appointments/99999`)
      .set("SESSION-TOKEN", "token-veterinarian");
